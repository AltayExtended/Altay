...
use pocketmine\depends\generator\overworld\decorator\CactusDecorator;
use pocketmine\depends\generator\overworld\decorator\DeadBushDecorator;
use pocketmine\depends\generator\overworld\decorator\DoublePlantDecorator;
use pocketmine\depends\generator\overworld\decorator\FlowerDecorator;
use pocketmine\depends\generator\overworld\decorator\LakeDecorator;
use pocketmine\depends\generator\overworld\decorator\MushroomDecorator;
use pocketmine\depends\generator\overworld\decorator\PumpkinDecorator;
use pocketmine\depends\generator\overworld\decorator\SugarCaneDecorator;
use pocketmine\depends\generator\overworld\decorator\SurfaceCaveDecorator;
use pocketmine\depends\generator\overworld\decorator\TallGrassDecorator;
use pocketmine\depends\generator\overworld\decorator\TreeDecorator;
use pocketmine\depends\generator\overworld\decorator\types\FlowerDecoration;
use pocketmine\depends\generator\overworld\decorator\types\TreeDecoration;
use pocketmine\depends\generator\overworld\decorator\UnderwaterDecorator;
