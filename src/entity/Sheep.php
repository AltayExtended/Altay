...
class Sheep extends AltayEntity{
	...
	public function getDrops() : array{
		...
		$drops = [
			ItemFactory::getInstance()->get(ItemIds::WOOL, 0, mt_rand(0, 1 * $looting)),
			ItemFactory::getInstance()->get(ItemIds::RAW_MUTTON, 0, mt_rand(0, 1 * $looting))
		];
