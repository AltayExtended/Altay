...
class Cow extends AltayEntity{
	...
	public function getDrops() : array{
		...
		$drops = [
			ItemFactory::getInstance()->get(ItemIds::LEATHER, 0, mt_rand(0, 1 * $looting)),
			ItemFactory::getInstance()->get(ItemIds::RAW_BEEF, 0, mt_rand(0, 1 * $looting))
		];
