...
class PiglinBrute extends AltayEntity{

	const TYPE_ID = EntityLegacyIds::PIGLIN_BRUTE;
	const HEIGHT = 1;
	...
	public function getDrops() : array{
		...
		$drops = [
			ItemFactory::getInstance()->get(ItemIds::GOLD_AXE, 0, mt_rand(0, 1 * $looting))
		];
