...
class Axolotl extends AltayEntity{

	const TYPE_ID = EntityLegacyIds::AXOLOTL;
	const HEIGHT = 1;
	...
	public function getDrops() : array{
		...
		$drops = [
			ItemFactory::getInstance()->get(ItemIds::RAW_FISH, 0, mt_rand(0, 1 * $looting))
		];
