...
class Skeleton extends AltayEntity{
	...
	public function getDrops() : array{
		...
		$drops = [
			ItemFactory::getInstance()->get(ItemIds::ARROW, 0, mt_rand(0, 1 * $looting)),
			ItemFactory::getInstance()->get(ItemIds::BONE, 0, mt_rand(0, 1 * $looting))
		];
